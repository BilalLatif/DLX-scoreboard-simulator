...
int main()
{
	...
	Instruction[7]="LD F6,34(R2)";
	Instruction[8]="LD F2,45(R3)";
	Instruction[9]="MUL F0,F2,F4";
	Instruction[10]="SUB F8,F6,F2";
	Instruction[11]="DIV F10,F0,F6";
	Instruction[12]="ADD F6,F8,F2";
	string InstructionDetails[13][5];
	...
	InstructionDetails[7][0]="LDSD";
	InstructionDetails[7][1]="F6";
	InstructionDetails[7][2]="R2";
	InstructionDetails[7][3]="";
	InstructionDetails[7][4]="";
	InstructionDetails[8][0]="LDSD";
	InstructionDetails[8][1]="F2";
	InstructionDetails[8][2]="R3";
	InstructionDetails[8][3]="";
	InstructionDetails[8][4]="";
	InstructionDetails[9][0]="MUL0";
	InstructionDetails[9][1]="F0";
	InstructionDetails[9][2]="F2";
	InstructionDetails[9][3]="F4";
	InstructionDetails[9][4]="";
	InstructionDetails[10][0]="ADDD";
	InstructionDetails[10][1]="F8";
	InstructionDetails[10][2]="F6";
	InstructionDetails[10][3]="F2";
	InstructionDetails[10][4]="";
	InstructionDetails[11][0]="DIV";
	InstructionDetails[11][1]="F10";
	InstructionDetails[11][2]="F0";
	InstructionDetails[11][3]="F6";
	InstructionDetails[11][4]="";
	InstructionDetails[12][0]="ADDD";
	InstructionDetails[12][1]="F6";
	InstructionDetails[12][2]="F8";
	InstructionDetails[12][3]="F2";
	InstructionDetails[12][4]="";
